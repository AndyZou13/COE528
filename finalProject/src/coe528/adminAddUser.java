...
public class adminAddUser extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        //will screw up delete function if sortable therefore disable sort
...
//        pntCol.setSortable(false);
        ...
        btAdd.setOnAction(
            ...
            public void handle(ActionEvent e) {
                ...
                if (addUser.getText().trim().isEmpty() || addPass.getText().trim().isEmpty()) {
                    ...
                    boolean add = true;
                    for (User user : users) {
                        if (user.getUsername().equals(addUser.getText())) {
                            add = false;
                            break;
                        }
        ...
        btDel.setOnAction(
            ...
            public void handle(ActionEvent e) {
                ...
                Object output = getName.getTableColumn().getCellData(index);
                ...
                for(int i = 0; i < users.size(); i++) {
                    ...
                    if(users.get(i).getUsername().equals(output)) {
                        users.remove(i);
                    }
                }
        ...
        btBack.setOnAction(
            ...
            @Override
            public void handle(ActionEvent e) {
                //test so far until scene previous is available
                //creating new scene and test button and random HBox
                //i will change during implementation
                Scene trys = new Scene(new Group());
                Button btTry = new Button("Back buttons");
                HBox prompt = new HBox();
                prompt.getChildren().addAll(btTry);
                ((Group) trys.getRoot()).getChildren().addAll(prompt);
                primaryStage.setScene(trys);
